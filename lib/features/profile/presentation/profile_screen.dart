                  ...
                  AppCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _dataRow(context, 'Nombre Completo',
                            profile.fullName.isNotEmpty ? profile.fullName : '—'),
                        _dataRow(context, 'Apellidos',
                            profile.lastName.isNotEmpty ? profile.lastName : '—'),
                        _dataRow(context, 'Email',
                            profile.email.isNotEmpty ? profile.email : '—'),
                        _dataRow(context, 'Número de Celular',
                            profile.phoneNumber.isNotEmpty ? profile.phoneNumber : '—'),
                        _dataRow(context, 'Carnet/NIT',
                            profile.idNumber.isNotEmpty ? profile.idNumber : '—'),
                        _dataRow(context, 'Dirección', profile.address?.isNotEmpty == true ? profile.address! : '—'),
                        _dataRow(context, 'Número de Cuenta',
                            profile.accountNumber.isNotEmpty ? profile.accountNumber : '—'),
                        _dataRow(context, 'Nombre del banco',
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            final bool hasTempPhoto =
                (tempPhoto?.isNotEmpty ?? false) && File(tempPhoto!).existsSync();
            final ImageProvider? tempPhotoImage =
                hasTempPhoto ? FileImage(File(tempPhoto!)) : null;
            return Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _inputField('Nombre Completo', fullNameCtrl,
                        textInputAction: TextInputAction.next),
                    _inputField('Apellidos', lastNameCtrl,
                        textInputAction: TextInputAction.next),
                    _inputField('Email', emailCtrl,
                        keyboardType: TextInputType.emailAddress,
                        textInputAction: TextInputAction.next),
                    _inputField('Número de Celular', phoneCtrl,
                        keyboardType: TextInputType.phone,
                        textInputAction: TextInputAction.next),
                    _inputField('Carnet/NIT', idCtrl,
                        textInputAction: TextInputAction.next),
                    _inputField('Dirección (Opcional)', addressCtrl,
                        textInputAction: TextInputAction.next),
                    _inputField('Número de Cuenta', accountCtrl,
                        keyboardType: TextInputType.number,
                        textInputAction: TextInputAction.next),
                    _inputField('Nombre del banco', bankCtrl,
